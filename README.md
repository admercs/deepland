...
[![Build Status](https://travis-ci.org/adam-erickson/deepland.svg?branch=master)](https://travis-ci.org/adam-erickson/deepland)
...
The cost is added complexity and duplication, which `pybind11` minimizes compared to other approaches. While CMake is also complex, it effectively enables cross-platform support for C++.
